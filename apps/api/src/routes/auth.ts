...
authRouter.openapi(
  createRoute({
    ...
    responses: {
      200: { content: { "application/json": { schema: OkSchema } }, description: "Token verified, session cookie set" },
      400: { content: { "application/json": { schema: ErrorSchema } }, description: "Missing token" },
      401: { content: { "application/json": { schema: ErrorSchema } }, description: "Invalid or expired token" },
    },
  }),
  async (c) => {
...
authRouter.openapi(
  createRoute({
    ...
    responses: {
      200: { content: { "application/json": { schema: UserSchema.omit({ createdAt: true }) } }, description: "Current user" },
