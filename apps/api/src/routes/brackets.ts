...
bracketsRouter.openapi(
  createRoute({
    ...
    responses: {
      200: { content: { "application/json": { schema: z.object({ ok: z.boolean() }) } }, description: "Vote recorded" },
      400: { content: { "application/json": { schema: ErrorSchema } }, description: "Invalid suggestion or bracket already resolved" },
      ...
      404: { content: { "application/json": { schema: ErrorSchema } }, description: "Bracket not found" },
    },
  }),
  async (c) => {
